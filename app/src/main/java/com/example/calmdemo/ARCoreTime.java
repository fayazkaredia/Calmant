...
public class ARCoreTime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arcore_time);
        ...
        Button shoot = findViewById(R.id.shootButtonb);
